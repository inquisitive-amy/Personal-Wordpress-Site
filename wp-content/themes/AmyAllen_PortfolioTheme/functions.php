...
function theme_setup() {
	...
	add_image_size('wide', 1000, 200, true);
	add_image_size('portfolio', 495);
	add_image_size('portLarge', 750);
	add_image_size('full', 1000);
...
function twentyten_posted_in() {
	...
	if ( $tag_list ) {
		$posted_in = __( 'Categories: %1$s Tags: %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'twentyten' );
...
//Disable the editor under appearances
